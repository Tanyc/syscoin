...
<body>
  ...
  <style type="text/css">.navibar_<?php echo ($curID); ?>{color: #ff0000; font-weight:bold;}</style>
  <!--------------------------------------------------->
  <div id="body_content">
    ...
    <div class="div_content">
      <div class="activity">
        ...
        <div class="notice_list">
          <ul >
            <?php if(is_array($activity)): $i = 0; $__LIST__ = $activity;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if(($vo[id] % 2) == "0"): ?>style="background:#f2f2f2"<?php endif; ?>
              >
              <a href="<?php echo U('/App/Modules/Home/Tpl/notice/'.$vo['id']);?>"><?php echo ($vo["title"]); ?></a>
  ...
  <div class="div_content">
    <div class="webmessage">
      ...
      <div class="notice_list">
        <ul >
          <?php if(is_array($notice)): $i = 0; $__LIST__ = $notice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if(($vo[id] % 2) == "0"): ?>style="background:#f2f2f2"<?php endif; ?>
            >
            <a href="<?php echo U('__HOME__/Tpl/notice/'.$vo['id']);?>"><?php echo ($vo["title"]); ?></a>
          </li><?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
    </div>
  </div>
