      ...
      <div class=game_tab>
        <div style="width:970px">
          ...
          <div style=" float:right; width:330px; height:25px;vertical-align:middle; line-height:25px;text-align:right">
            <a href="/nbbs/bbsPost.aspx?PostID=3864534&amp;topicid=4&amp;ret=1" target="_blank" style="color:#3f3f3f;">310游戏由各种体育赛事实时开奖&gt;&gt;&gt;</a>
            &nbsp;&nbsp;
          </div>
        </div>
      </div>
        ...
        <table width="978" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="24cf00">
          <tbody>
            <tr>
        ...
        <table width="978" border="0" cellpadding="0" cellspacing="1" bgcolor="#248301" style="margin-left:auto; margin-right:auto; color:Black;">
          <tbody>
            <tr align="center">
              <td width="8%" height="26" background="/img/pub/pg310_bg.gif" class="white">
                <span class="STYLE21">期号</span>
              </td>
              <td width="14%" background="/img/pub/pg310_bg.gif" class="white">
                <span class="STYLE21">赛事名称</span>
              </td>
              <td width="20%" background="/img/pub/pg310_bg.gif" class="white">
                <span class="STYLE21">赛事描述</span>
              </td>
              <td width="10%" background="/img/pub/pg310_bg.gif" class="white">
                <span class="STYLE21">比赛时间</span>
              </td>
              <td width="7%" background="/img/pub/pg310_bg.gif" class="white">
                <span class="STYLE21">分析</span>
              </td>
              <td width="7%" background="/img/pub/pg310_bg.gif" class="white">
                <span class="STYLE21">赛果</span>
              </td>
              <td width="8%" background="/img/pub/pg310_bg.gif" class="white">
                <span class="STYLE21">已投注数</span>
              </td>
              <td width="11%" background="/img/pub/pg310_bg.gif" class="white">
                <span class="STYLE21">金蛋总数</span>
              </td>
              <td width="8%" background="/img/pub/pg310_bg.gif" class="white">
                <span class="STYLE21">中奖人数</span>
              </td>
              <td width="7%" background="/img/pub/pg310_bg.gif" class="white">
                <span class="STYLE21">参与</span>
              </td>
            </tr>

            <tr align="center" bgcolor="#FFFFFF" class="font12">
              <td height="32" bgcolor="#e6f7e0">12239</td>
              <td height="28" bgcolor="#FFFFFF" class="font12">世杯热身</td>
              <td height="28" bgcolor="#FFFFFF" class="font12">厄瓜多尔 vs 英格兰</td>
              <td height="28" bgcolor="#FFFFFF" class="font12">06-05 02:00</td>
              <td height="28" bgcolor="#FFFFFF" class="font12">
                <a href="http://match.sports.sina.com.cn/livecast/show_date.php?date=2014-06-05" target="_blank">分析</a>
              </td>
              <td bgcolor="#FFFFFF">
                <script language="javascript" type="text/javascript">chkResult('','-');</script>
                -
              </td>
              <td bgcolor="#FFFFFF" class="font12">317</td>
              <td bgcolor="#FFFFFF" class="font12">
                222,231,827
                <img src="__IMAGES__/game/egg.gif"></td>
              <td height="28" bgcolor="#FFFFFF" class="font12">
                <script language="javascript" type="text/javascript">chkwin('0','291953');</script>
                0
              </td>
              <td bgcolor="#FFFFFF" class="font12">
                <script language="javascript" type="text/javascript">chkStatus('0','291953');</script>
                <a class="a0" href="/play/pg310Insert.aspx?LID=291953" target="_top">投注</a>
              </td>
            </tr>
...
-->
                ...
                <table cellspacing="2" cellpadding="2" style="font-family:Tahoma; font-size:12px; text-align:center; border:0; width:100%;" class="phoenix">
                  <!--<form id="pagination" method="post" action="/play/Pg310.aspx">        
                  -->
                    ...
                    <tr valign="middle">
                      <td align="left">
                        <span title="记录总数" style="cursor:pointer;">
                          ...
                          <span style="color:#000066; font-weight:bold;">11630</span>
                        </span>
                        <span title="总页数" style="cursor:pointer;">
                          <span class="common">&nbsp;&nbsp;总页数：</span>
                          <span style="color:#000066;font-weight:bold;">1163</span>
                        </span>
                        &nbsp;&nbsp;
                      ...
                      <td align="center">
                        ...
                        <a href="javascript:onsubmit(1163);" target="_top">
