<%@ Page Language="C#" MasterPageFile="~/Reader/ReaderMasterPage.master" AutoEventWireup="true" CodeFile="SearchBook.aspx.cs" Inherits="Reader_SearchBook" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table >
        <tr >
            ...
            <td ><asp:Button ID ="btnSearch" Text="搜索" runat="server" OnClick="btnSearch_Click" /></td>
        </tr>
        <tr>
            <td　 colspan="7">
                 <asp:GridView  ID ="BookList" runat ="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="841px" Height="142px" OnRowDataBound="BookList_RowDataBound" >
                     <Columns>
