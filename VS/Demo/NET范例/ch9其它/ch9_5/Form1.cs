...
namespace ch9_5
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "CultureInfo 设置为";
			// 
			// label2
			// 
			...
			this.label3.Text = "三个字母的 ISO 语言名称为";
			// 
			// label4
			// 
