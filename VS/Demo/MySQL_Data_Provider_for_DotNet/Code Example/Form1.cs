...
namespace WindowsApplication1
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtInitialDB.Text = "mysqlclienttest";
			// 
			// label3
			// 
			...
			this.label11.Text = "Transactions will only work if you have InnoDB tables enabled!";
			// 
			// Form1
			// 
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
			...
			m_objDA.UpdateCommand = new MySQLCommand("UPDATE user SET Alias=?, Name=?, Rating=?, BirthDay=? WHERE UserID=?", m_objCon);
			m_objDA.InsertCommand = new MySQLCommand("INSERT INTO user SET Alias=?, Name=?, Rating=?, BirthDay=?", m_objCon);
			m_objDA.DeleteCommand = new MySQLCommand("DELETE FROM user WHERE UserID=?", m_objCon);

			m_objDA.InsertCommand.Parameters.Add("Alias");
			m_objDA.InsertCommand.Parameters.Add("Name");
			m_objDA.InsertCommand.Parameters.Add("Rating");
			m_objDA.InsertCommand.Parameters.Add("Birthday");
			...
			m_objDA.UpdateCommand.Parameters[4].SourceVersion = DataRowVersion.Original;

			m_objDA.DeleteCommand.Parameters.Add("UserID");
			m_objDA.DeleteCommand.Parameters[0].SourceVersion = DataRowVersion.Original;
		}
		#endregion
