...
{
	/// <summary>
	/// Provides data for the System.Data.MySQLClient.MySQLDataAdapter.RowUpdating event.
	/// </summary>
	public sealed class MySQLRowUpdatingEventArgs : RowUpdatingEventArgs
	{
		public MySQLRowUpdatingEventArgs(DataRow objDataRow, IDbCommand objCommand, StatementType enmStatementType, DataTableMapping objTableMapping)
