...
namespace WindowsFormsApplication
{
    class Define
    {
        public static String Domain = "https://www.okcoin.com/";
        public static String QQ = Domain + "user/appLoad.do";//QQ绑定
        //public static String QQ = Domain + "user/userinfo.do";//QQ绑定
        public static String Reset = Domain + "user/reset.do";

        //public static String Domain = "http://localtest.OKCoin.com/";
        public static String Login = Domain + "api/login.do";
        public static String GoogleCheckUrl = Domain + "api/submitTotpCode.do";//登录二次验证:


        public static String checkVersion = Domain + "api/checkVersion.do";//版本检查

        
        public static String Userinfo = Domain + "api/userinfo.do";
        public static String Assets = Domain + "api/getAssets.do";
        public static String Tickerinfo = Domain + "api/tickerinfo.do";//各网站行情信息
        public static String Trade = Domain + "api/trade.do";//
        public static String Depth = Domain + "api/depth.do";//委单
        public static String Order = Domain + "api/getorder.do";//获取用户挂单
        public static String OrderHistory = Domain + "api/getOrderHistory.do";//获取用户历史委托



        public static String CancelOrder = Domain + "api/cancelorder.do";//撤销订单
        public static String AccountRecord = Domain + "api/getAccountRecord.do";//获取账单信息
