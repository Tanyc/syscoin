...
namespace HttpFtpEx42
{
    class HttpFile
    {
        ...
        private delegate void DelegateSetListBox(string str);//代理
        //线程的执行方法
        //public void ThreadReveive()
        //{
        //    DelegateSetListBox df = new DelegateSetListBox(receive);
        ...
        public void receive()//接收线程
        {
            ...
            string str = "线程" + threadh.ToString() + "开始接收";
            DelegateSetListBox df = new DelegateSetListBox(SetListBox);
            df.BeginInvoke(str,null,null);
